...
public class MemberService {
	 ...
	 * @throws SQLException 
	 */
	public int insertCertification(String inputEmail, String cNumber) throws SQLException {
	...
	public String checkNumberService(String inputEmail) throws SQLException {
		
		Connection conn = getConnection();
		
		String pNumber = dao.checkNumberService(conn, inputEmail);
